 ...
 *                1. a) If the the function returns 1, and the key passed
 ...
 *                   b) If a 0 is returned in 'keyout', indicating that the
 ...
 *                   if key was not used. \n
 *\n
 *                2. If the function returns 0, then object the key acted on
 ...
 *                   using mt_objc_edit() \n
 *                NOTE: \n
 *                      XaAES may return a new editfocus even if the key was not
