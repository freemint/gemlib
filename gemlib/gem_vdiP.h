               ...
               long cntrl_0_1, long cntrl_3, long cntrl_5, short handle)
{
	__asm__ volatile ("
		...
		"
		:
		: "a"(vdipb), "g"(cntrl_0_1), "d"(cntrl_3), "d"(cntrl_5), "g"(handle)
		: "a0", "d0","d1"
	);
}
...
static inline void
_vdi_trap (VDIPB * vdipb, long cntrl_0_1, long cntrl_3, short handle)
{
	__asm__ volatile ("
		movea.l %0, a0;    | &vdipb
		move.l  a0, d1;
		...
		move.l  %1, (a0)+; | cntrl_0, cntrl_1
		move.l  %2, (a0)+; | cntrl_2, cntrl_3
		clr.l       (a0)+; | cntrl_4, cntrl_5
		move.w  %3, (a0);  | handle
		move.w  #115, d0;  | 0x0073
		trap    #2;
		"
		:
		: "a"(vdipb), "g"(cntrl_0_1), "d"(cntrl_3), "g"(handle)
		: "a0", "d0","d1"
	);
}
#define VDI_TRAP(vdipb, handle, opcode, cntrl_1, cntrl_3) \
	_vdi_trap (&vdipb, (opcode##uL<<16)|cntrl_1, cntrl_3, handle)
